...
window.onload = () => {
  ...
  // Revela el body con un wipe vertical
  timeline.fromTo(
    "body",
    { clipPath: "inset(100% 0 0 0)" },
    { clipPath: "inset(0% 0 0 0)", duration: 0.8, ease: "power4.out" }
  )
  // Anima la sección hero: un clipPath que se abre y el redondeo de esquinas
  .fromTo(
    ".hero",
  ...
  // Revela el contenedor de control con un clipPath que se abre de derecha a izquierda
  .fromTo(
    ".control-content",
  ...
  // Aparece la foto personal con un leve scale y fade in
  .fromTo(
    ".personal-photo",
    { opacity: 0, scale: 0.8 },
    { opacity: 1, scale: 1, duration: 0.5, ease: "power4.out", stagger: 0.1 },
    "-=0.4"
  )
  // Anima los iconos de navegación con un ligero slide vertical
  .fromTo(
    ".icon-button",
    { opacity: 0, y: 20 },
  ...
  // Aparece el tag button desplazado desde la izquierda
  .fromTo(
    ".tag-btn",
    { opacity: 0, x: -30 },
    { opacity: 1, x: 0, duration: 0.75, ease: "power4.out" },
    "-=0.3"
  )
  // Revela la imagen principal de la sección hero con clipPath y un movimiento vertical
  .fromTo(
    ".hero-image",
  ...
  // Revela el título principal: un clipPath que se desliza desde la derecha
  .fromTo(
    ".main-title",
    { clipPath: "inset(0 100% 0 0)" },
  ...
  // Finalmente, revela el subtítulo principal con un clipPath
  .fromTo(
    ".main-subtitle",
    { clipPath: "inset(100% 0 0 0)" },
