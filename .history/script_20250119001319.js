    ...
    document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
        ...
        if (index === activeIndex) {
            ...
            if (activeIndex > previousIndex) {
                ...
                image.style.transition = 'transform 0.1s ease-out'; // Smooth transition
                image.style.transform = `translateX(-1%)`; // Shift to the right
            } else if (activeIndex < previousIndex) {
                // Going to the previous slide
                image.style.transition = 'transform 0.5s ease-out'; // Smooth transition
                image.style.transform = `translateX(1%)`; // Shift to the left
            }
        } else {
