...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll('.swiper-slide .imagen-contenida').forEach((image) => {
        ...
        image.style.transition = 'none'; // Ensure no animations on load
    });
});
...
swiper.on('slideChangeTransitionStart', () => {
    ...
    document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
        ...
        // Debugging logs to ensure correct offset values
        console.log(`Slide index: ${index}, Active index: ${activeIndex}, Offset: ${offset}%`);
...
// Reset images when transition ends
swiper.on('slideChangeTransitionEnd', () => {
    document.querySelectorAll('.swiper-slide .imagen-contenida').forEach((image) => {
        image.style.transition = ''; // Remove transition to avoid conflicts
    });
});
