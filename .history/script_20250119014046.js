...
document.addEventListener("mousemove", (e) => {
    ...
    // Verifica si el elemento tiene el cursor en pointer
    ...
    if (computedStyle.cursor === "pointer") {
        ...
        customCursor.style.backgroundColor = "rgba(255, 255, 255, 0.1)"; // Cambia el color si es necesario
    }
    else if (target.classList.contains("next-project-btn")) {
        customCursor.style.transform = `translate(-50%, -50%) scaleX(2.5)`;
    }
    else {
        // Resetea el cursor
