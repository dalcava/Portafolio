...
document.addEventListener("mousemove", (e) => {
    ...
    if (target.classList.contains("next-project-btn")) {
        ...
        customCursor.style.backgroundColor = "rgba(20, 1, 1, 0.97)";
        customCursor.style.borderRadius = "24px%";
        customCursor.transition= "transform 0.35s ease-out, background-color 0.3s ease, border-radius 0.3s ease, z-index 0.3s ease"
