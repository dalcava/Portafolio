...
document.addEventListener("mousemove", (e) => {
    ...
    interactiveElements.forEach((element) => {
        ...
        // Check proximity to the element (large radius for strong attraction)
        const proximityRadius = 500; // Very large radius for far attraction
        ...
        if (distance < proximityRadius) {
            ...
            // Strongly pull cursor directly to the element's center
            const attractionStrength = 1.0; // Cursor abandons user position entirely
