...
window.onload = () => {
    ...
    timeline
        ...
        .fromTo(
            ".description",
            { clipPath: "inset(100% 0 0 0)" },
            { clipPath: "inset(0% 0 0 0)", duration: 1, ease: "power4.out", stagger: 0.5},
            "-=0.75"
        )
        .fromTo(
            ".swiper-slide",
            { clipPath: "inset(100% 0 0 0)" }, // Start invisible and slightly below
            { clipPath: "inset(0% 0 0 0)", duration: 1, easeout: "power4.out", stagger: 0.5 }, // Fade and move in
            "-=0.5" // Start overlapping with the previous animation
        );
/*         .fromTo(
            ".swiper-slide",
            { opacity: 0, y: 50 }, // Start invisible and slightly below
            { opacity: 1, y: 0, duration: 1, ease: "power4.out", stagger: 0.5 }, // Fade and move in
            "-=0.5" // Start overlapping with the previous animation
        ); */
};
