...
window.onload = () => {
    ...
    .fromTo(
        "#canvas1",
        { opacity: 0, y: 50 }, // Start invisible and slightly below
        { opacity: 1, y: 0, duration: 0.5, easeout: "power4.out", stagger: 0.5 } // Fade and move in
         // Start overlapping with the previous animation
    )
    .fromTo(
        ".swiper-slide",
        { opacity: 0, y: 150 }, // Start invisible and slightly below
        { opacity: 1, y: 0, duration: 1.2, ease: "power4.out", stagger: 0.5 } // Fade and move in
         // Start overlapping with the previous animation
    )
    .fromTo(
        ".main-title",
