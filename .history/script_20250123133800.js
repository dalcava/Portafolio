...
gsap.to(".swiper-wrapper", {
    x: "-50%", // Moves the carousel to the left
    ease: "power2.out", // Easing effect
    scrollTrigger: {
        trigger: ".boolean-container", // Section to track
        start: "top top", // When the container hits the top of the viewport
        end: "bottom top", // When the container is completely out of view
        scrub: true, // Smooth scrubbing
        pin: true, // Keep the container pinned while animating
    },
});
