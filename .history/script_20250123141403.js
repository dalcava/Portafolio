swiper.slideNext()const canvas = document.getElementById('canvas1');
...
// Variable to prevent rapid animations
...
const navigateSwiper = (direction) => {
    ...
    setTimeout(() => (isAnimating = false), 800); // Match Swiper animation duration
};

// ScrollTrigger setup
ScrollTrigger.create({
    trigger: ".boolean-container", // Swiper container
    ...
    onUpdate: (self) => {
        navigateSwiper(self.direction); // Call navigation based on scroll direction
    },
});
