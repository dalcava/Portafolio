...
// ScrollTrigger to monitor mapped space
ScrollTrigger.create({
    trigger: ".boolean-container", // Replace with your mapped space container
    ...
    onEnter: () => toggleOverflow(false), // Disable scrolling when entering the space
    onLeave: () => toggleOverflow(true), // Enable scrolling when leaving downward
    onEnterBack: () => toggleOverflow(false), // Disable scrolling when entering from the bottom
    onLeaveBack: () => toggleOverflow(true), // Enable scrolling when leaving upward
});    