...
// Elements with interactive properties
const interactiveElements = document.querySelectorAll(".swiper-slide, .swiper-pagination-bullet, .swiper-button-next, .swiper-button-prev");

// Mouse movement and cursor interaction
document.addEventListener("mousemove", (e) => {
    let isNearInteractive = false;

    interactiveElements.forEach((element) => {
        const rect = element.getBoundingClientRect();
        const proximityRadius = 300; // Detection radius
...
// Cursor appearance on specific elements
