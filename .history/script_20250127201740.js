...
document.addEventListener("mousemove", (e) => {
    ...
    interactiveElements.forEach((element) => {
      ...
      const proximityRadius = 150; // Adjust the magnetic pull radius
      ...
      if (distance < proximityRadius) {
        ...
        const pullStrength = 0.2; // Pull factor, lower is stronger
    ...
    // Default cursor follow if not near an interactive element
