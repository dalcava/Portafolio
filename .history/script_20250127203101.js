...
document.addEventListener("mousemove", (e) => {
    ...
    // Check if the element has a pointer cursor
        ...
        customCursor.style.transform = `translate(-50%, -50%) scale(1)`;
        customCursor.style.backgroundColor = "rgba(188, 36, 74, 0.5)"; // Default color
        customCursor.style.borderRadius = "4px"; // Default shape
        ...
        customCursor.style.border = "1px solid 
        customCursor.style.border = "1px solid rgba(188, 36, 74, 0.5)";;
    }
});
