...
const interactiveElements = document.querySelectorAll(".next-project-btn, .swiper-button-next, .swiper-button-prev, .swiper-pagination-bullet, .Lightbulb, .menu, .icon-button");
...
document.addEventListener("mousemove", (e) => {
    ...
    interactiveElements.forEach((element) => {
        ...
        const proximityRadius = 100000; // Large radius for detection
