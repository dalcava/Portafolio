...
window.onload = () => {
    ...
    timeline
        .fromTo(
            ...
            { clipPath: "inset(0% 0 0 0)", duration: 0.75, ease: "power4.out", stagger: 0.75  },
            
        )
        .fromTo(
            ".hero",
            { borderRadius: "0px", clipPath: "inset(100% 0 0 0)"},  // Initial state
            { borderRadius: "4px 32px 4px 32px", duration: 1, clipPath: "inset(0% 0 0 0)", duration: 1.2, ease: "power4.out", stagger: 0.5 } // Final state with duration
        )
        .fromTo(
            "#canvas1",
