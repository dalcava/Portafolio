...
window.onload = () => {
    ...
    timeline
        ...
        .fromTo(
            ...
            { clipPath: "inset(0% 0 0 0)", duration: 1.2, ease: "power4.out", borderRadius: "4px 32px 4px 32px", duration: 1 }, // Final state with duration
            "-=2"
        )
        .fromTo(
            "#canvas1",
        ...
        .fromTo(
            ...
            { opacity: 1, y: 0, duration: 2.5, ease: "power4.out", stagger: 0.5 } // Fade and move in
        )
        .fromTo(
            ".personal-photo",
