...
window.onload = () => {
    ...
    timeline
        ...
        .fromTo(
            ...
            { clipPath: "inset(0% 0 0 0)", duration: 1.2, ease: "power4.out"}, // Final state with duration
            "-=2"
        )
        .fromTo(
            ".hero",
            {borderRadius: "0px"},  // Initial state
            {borderRadius: "4px 32px 4px 32px", duration: 1 }, // Final state with duration
            "-=2"
        )
        .fromTo(
            "#canvas1",
