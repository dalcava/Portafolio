...
window.onload = () => {
    ...
    timeline
        .fromTo(
            ...
            { clipPath: "inset(0% 0 0 0)", duration: 0.5, ease: "elastic.out(1, 0.3)"},
            
        )
        .fromTo(
            ".hero",
            { clipPath: "inset(100% 0 0 0)", borderRadius: "0px"},  // Initial state
            { clipPath: "inset(0% 0 0 0)", duration: 1.2, ease: "elastic.out(1, 0.3)", borderRadius: "32px", duration: 1 }, // Final state with duration
            "-=2"
        )
        .fromTo(
            "#canvas1",
