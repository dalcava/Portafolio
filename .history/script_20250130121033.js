...
/*             { opacity: 0, x: -300 }, // Start invisible and slightly below
            ...
            { clipPath: "inset(0% 0 0 0)", y:0, duration: 1, ease: "elastic.out(1, 0.75)" },
            "-=0"
        )
        .fromTo(
            ".main-subtitle",
        ...
        .fromTo(
            ...
            { opacity: 1, y: -45, x:0, duration: 0.75, ease: "elastic.out(1, 0.75)", stagger: 0.25 },
            "-=0.2" // Fade and move in
        )
        .fromTo(
            ".title",
            { clipPath: "inset(100% 0 0 0)" },
