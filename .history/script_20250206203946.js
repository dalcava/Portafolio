...
swiper.on('slideChangeTransitionStart', () => {
    ...
    document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
        ...
        // Si el slide es el activo o no tiene la clase 'swiper-slide-prev',
        // se centra la imagen
        if (slide.classList.contains('swiper-slide-active') || !slide.classList.contains('swiper-slide-prev')) {
            image.style.transition = 'transform 0.35s ease-out';
            image.style.transform = 'translateX(0%)'; // Centrar la imagen
        } else {
            // En el caso de que el slide tenga la clase 'swiper-slide-prev',
            // se aplica un offset calculado
