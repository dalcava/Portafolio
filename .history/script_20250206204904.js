...
swiper.on('slideChangeTransitionStart', () => {
    ...
    document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
        ...
        // Si el slide es el activo o NO es prev y NO es next, centrar la imagen
        if (slide.classList.contains('swiper-slide-active') || 
            ...
            image.style.transform = 'translateX(0%)'; // Centrar la imagen
        } 
        else {
            // Si es prev o next, aplicar un offset para separarlo visualmente
...
// Asegurar la corrección al final de la transición
swiper.on('slideChangeTransitionEnd', () => {
    requestAnimationFrame(() => { // Asegura la actualización visual
        const activeIndex = swiper.activeIndex;
        ...
        document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
            ...
            // Reajustar todas las imágenes para asegurarse de que están en su posición correcta
            if (slide.classList.contains('swiper-slide-active') || 
                (!slide.classList.contains('swiper-slide-prev') && !slide.classList.contains('swiper-slide-next'))) {
