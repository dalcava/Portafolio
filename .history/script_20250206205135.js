...
function updateSlidePositions() {
    ...
    document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
        ...
        // Force the image to be visible and positioned correctly
        image.style.opacity = "1"; // Ensure visibility
        ...
        if (slide.classList.contains('swiper-slide-active') || 
            ...
            image.style.transform = 'translateX(0%)'; // Center the image
        } 
        else {
            // If it's prev or next, apply an offset
...
// Apply corrections at key moments
...
swiper.on('touchEnd', () => {
    ...
    correctionTimeout = setTimeout(updateSlidePositions, 100); // Small delay for final correction
});

// 🔥 **NEW FIX: Watch for Swiper changes in real-time**
const observer = new MutationObserver(updateSlidePositions);
