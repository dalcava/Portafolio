...
// Apply corrections at key moments with smooth easing
...
// Continuous update while dragging (smoothed)
...
swiper.on('touchEnd', () => {
    ...
    correctionTimeout = setTimeout(updateSlidePositions, 1000); // Small delay for final correction
});
