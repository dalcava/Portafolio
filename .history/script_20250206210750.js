...
function updateSlidePositions(smooth = true) {
    ...
    document.querySelectorAll('.swiper-slide').forEach((slide, index) => {
        ...
        if (slide.classList.contains('swiper-slide-active') || 
            ...
            image.style.transition = smooth ? 'transform 0.35s ease-out' : 'none';
            ...
            image.style.transition = smooth ? 'transform 0.6s ease-out' : 'none';
...
// 🔥 **NEW FIX: Observe changes and apply smooth updates during transitions**
