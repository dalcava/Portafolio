...
window.addEventListener('load', () => {
    ...
    // Animación: mueve el contenedor fuera de la pantalla hacia abajo (100% de su altura)
    gsap.to(loadingScreen, {
      y: '100%',      // Desplaza el contenedor hacia abajo
      duration: 0.8,  // Duración de la animación (ajusta según prefieras)
      ease: "power2.inOut",
      onComplete: () => {
