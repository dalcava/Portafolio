...
window.addEventListener('load', () => {
    ...
    // Caída con efecto elástico y una ligera rotación
    tl.to(loadingScreen, {
      y: '100%',
    ...
    // Aplicar squash (comprimir horizontalmente y estirar verticalmente) justo al final
    .to(loadingScreen, {
      scaleX: 0.7,
      scaleY: 1.3,
      duration: 0.2,
      ease: "power2.out"
    }, "-=0.3") // Solapa un poco con la caída para que se sienta el impacto
    // Volver a la escala normal con un rebote elástico
    .to(loadingScreen, {
      scaleX: 1,
      scaleY: 1,
      duration: 0.3,
