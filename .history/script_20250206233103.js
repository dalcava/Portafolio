...
window.addEventListener('load', () => {
    ...
    tl.to(loadingScreen, {
      // Comienza la caída y simultáneamente cambia el border radius
      y: '100%',
      rotation: 3,        // Rotación sutil para dinamismo
      borderRadius: "32px",
      ease: "power4.in",   // Aceleración elegante
      duration: 1.2,
    })
    .to(loadingScreen, {
      // Efecto squash & stretch al impactar
      scaleX: 0.85,
      scaleY: 1.15,
      ease: "power2.out",
      duration: 0.2
    }, "-=0.3") // Solapa ligeramente para que se sienta natural
    .to(loadingScreen, {
      // Restaura la escala y elimina la rotación con un rebote sutil
      scaleX: 1,
      scaleY: 1,
      rotation: 0,
