...
document.addEventListener("mousemove", (e) => {
    ...
    if (target.classList.contains("swiper-pagination-bullet")) {
        ...
        customCursor.style.backgroundColor = "var(aaaaaaaaaaaaaaaa)";
    ...
    // Check if the element has a pointer cursor
        ...
        customCursor.style.backgroundColor = "var(aaaaaaaaaaaaaaaa)"; // Default color
        ...
        customCursor.style.border = "1px solid var(aaaaaaaaaaaaaaaa)";
    }
});
...
window.addEventListener("wheel", (e) => {
  ...
  scrollThrottle = now;
  const direction = Math.sign(e.deltaY*-20);
