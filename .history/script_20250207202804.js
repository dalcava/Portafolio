...
document.querySelectorAll(".swiper-slide").forEach((slide) => {
  ...
  window.addEventListener("mousemove", (e) => {
      ...
      if (isCursorInsideSlide) {
          ...
          activeGif.style.maskImage = `radial-gradient(circle at ${lastX}% ${lastY}%, black 25%, transparent 48%)`;
          activeGif.style.webkitMaskImage = `radial-gradient(circle at ${lastX}% ${lastY}%, black 25%, transparent 48%)`;
