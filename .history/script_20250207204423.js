...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Create an image inside the cursor for hover effect
  let cursorImage = document.createElement("img");
  cursorImage.src = "./Slider/Recursos/Eye.svg"; // Path to your eye icon
  cursorImage.id = "cursorImage";
  cursorImage.style.display = "none"; // Initially hidden

  // Append image to cursor
  ...
  document.addEventListener("mousemove", (e) => {
      ...
      if (target.classList.contains("swiper-pagination-bullet")) {
          // Pagination bullet hover effect
          customCursor.style.left = `${target.getBoundingClientRect().left + target.offsetWidth / 2}px`;
          customCursor.style.top = `${target.getBoundingClientRect().top + target.offsetHeight / 2}px`;
          ...
          cursorImage.style.display = "none"; // Hide the eye image
      } 
      
      else if (target.classList.contains("active-gif")) {
          // Hover effect for active GIF
          ...
          cursorImage.style.display = "block"; // Show the eye image
      } 
          ...
          cursorImage.style.display = "none"; // Hide eye image
      }
  });
});
